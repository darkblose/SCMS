...
<h2> 예약 취소</h2>
 ...
 <div class="form-label-group">
            	<label for="inputPassword">예약번호</label>
	<input type="text" id="inputReservationNumber" Name="RN" class="form-control" placeholder="예약 번호" required>
                
	</br></br>
	<button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit">예약취소</button>
