...
$id=$_SESSION['id'];
$sql = "SELECT M.U_ID,M_T.COURSE, M_T.COST FROM M,M_T,USERS where USERS.u_id=M.u_id and M.M_TYPE=M_T.M_TYPE and M.u_id = '$id' ";
...
//echo "<h1> My Membership </h1>";
echo "<TABLE border=4>";
echo "<TR>";
echo "<TH>아이디</TH><TH>등급</TH><TH>가격</TH>";
echo "</TR>";
...
?>
	...
	<button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit">멤버쉽 조회</button>
