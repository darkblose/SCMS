            ...
            <h5 class="card-title text-center">ADMIN</h5>
             <form action="admin_check.php" method="post" class="form-signin">
              <div class="form-label-group">
                <input type="text"  id="inputEmail" name="Aid" class="form-control" placeholder="ADMIN  ID" required autofocus>
                <label for="inputEmail">ADMIN  ID</label>
              </div>

              <div class="form-label-group">
                <input type="password" id="inputPassword" Name="APW" class="form-control" placeholder="ADMIN  PW" required>
                <label for="inputPassword">ADMIN  PW</label>
              </div>
