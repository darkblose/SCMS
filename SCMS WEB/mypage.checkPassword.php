...
<h2> Password 변경</h2>
 ...
 <div class="form-label-group">
	...
	<input type="password" id="inputPassword" Name="PWC" class="form-control" placeholder="Password" required>
                <label for="inputPassword">패스워드 확인</label>
	</br>
	<button class="btn btn-lg btn-primary btn-block text-uppercase" type="submit">패스워드 확인</button>
